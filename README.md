...
<p align="center">
  <img src="https://github.com/tbesnier/bm-shapes/blob/main/examples/tests/wiener_process/Q_identity_49coeffs.gif" alt="animated_sphere" style="width:70%"/>
  <img src="https://github.com/tbesnier/bm-shapes/blob/main/examples/tests/wiener_process_bunny/Q_identity_25coeffs.gif" alt="animated_bunny" style="width:70%"/>
</p>
